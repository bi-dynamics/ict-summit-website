...
(function( $ ){
	...
	$('#mu-event-counter').countdown('2018/10/15').on('update.countdown', function(event) {
   ...
   $('.mu-video-play-btn').on('click', function(event) {
	...
	/* ----------------------------------------------------------- */
	/*  5. EXHIBITORS SLIDEER ( SLICK SLIDER )
	/* ----------------------------------------------------------- */

	$('.mu-exhibitors-slider').slick({
		slidesToShow: 10,
		responsive: [
			{
				breakpoint: 768,
